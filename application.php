...
// Fetch all applications with related job and user information
$query = "SELECT applications.application_id, job_postings.title AS job_title, users.name AS applicant_name, applications.applied_at 
          FROM applications 
            ...
            <table class="table table-striped table-responsive">
                ...
                <tbody>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            <th scope="row"><?php echo htmlspecialchars($row['application_id']); ?></th>
