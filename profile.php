                ...
                <div class="panel">
                    ...
                    <div class="panel-body bio-graph-info shadow rounded p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="bio-row">
                                <p><span>Skills</span>: <?php echo htmlspecialchars($profile['skills']); ?></p>
                            </div>
                            <div class="bio-row">
                                <p><span>Portfolio URL:</span> <a href="<?php echo htmlspecialchars($profile['portfolio_url']); ?>" target="_blank"><?php echo htmlspecialchars($profile['portfolio_url']); ?></a></p>
                            </div>
                        </div>
                    </div>
                </div>
